...
class ClientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cliente" do
    assert_difference('Cliente.count') do
      post clientes_url, params: { cliente: { nome_empresa: @cliente.nome_empresa, site: @cliente.site } }
    end
  ...
  test "should update cliente" do
    patch cliente_url(@cliente), params: { cliente: { nome_empresa: @cliente.nome_empresa, site: @cliente.site } }
